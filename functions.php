<?php
/**
 * _rappid functions and definitions
 *
 * @package _rappid
 */
...
if ( ! function_exists( '_rappid_setup' ) ) :
/**
...
function _rappid_setup() {
	...
	if ( function_exists( 'add_theme_support' ) ) {
		...
		*/
		add_theme_support( 'custom-background', apply_filters( '_rappid_custom_background_args', array(
	 ...
	 * If you're building a theme based on _rappid, use a find and replace
	 * to change '_rappid' to the name of your theme in all the template files
	*/
	load_theme_textdomain( '_rappid', get_template_directory() . '/languages' );

	/**
	 * This theme uses wp_nav_menu() in one location.
	*/
	register_nav_menus( array(
		'primary'  => __( 'Header bottom menu', '_rappid' ),
	) );

}
endif; // _rappid_setup
add_action( 'after_setup_theme', '_rappid_setup' );

/**
 * Register widgetized area and update sidebar with default widgets
 */
function _rappid_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', '_rappid' ),
		'id'            => 'sidebar-1',
...
add_action( 'widgets_init', '_rappid_widgets_init' );

/**
 * Enqueue scripts and styles
 */
function _rappid_scripts() {
...
add_action( 'wp_enqueue_scripts', '_rappid_scripts' );
